...
const Home = () => {
    return (
      ...
      <div className="  flex justify-center mt-12">
        <h1 className="text-center  w-80 text-primary text-xl font-bold">Pilih Bahasa Pemrogaman</h1>
        </div>
  ...
  <div className="hero-content text-center">
    <div className="max-w-md text-white">
      ...
      <Link to="/js/1"><button className="btn btn-primary border-md border-white">Mulai</button></Link>
    </div>
  </div>
</div>
  ...
  <div className="hero-content text-center">
    <div className="max-w-md text-white">
      ...
      <p className="py-2">10 Soal </p>
      <Link to="/php/1"><button className="btn btn-primary border-solid border-white">Mulai</button></Link>
    </div>
  </div>
  </div>
</div>
